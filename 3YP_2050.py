...
# plot emmissions intensity over 2050
...
print("")
print("Current Situation (EVs included), Annual Net Load: %.2f MWh" % (sum(current)/1000))
print("")
print("Current Situation (EVs not included), Annual Net Load: %.2f MWh" % (sum(current_2)/1000))
print("")
